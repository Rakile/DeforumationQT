...
from PySide6.QtWidgets import QCheckBox, QLabel, QLineEdit, QSlider, QFrame, QPushButton, QFileDialog
...
class Deforumation_Prompt_Morphing_Frame():
    def __init__(self, index, parent=None, promptMorphConfigFrame=None):
        ...
        self.morph_prompt_enabled = True
    ...
    def setValuesFromConfig(self, promptMorphConfigFrame):
        if promptMorphConfigFrame != None:
            self.add_prompt_morph_blending_frame_to_container(promptMorphConfigFrame[1])
            self.morph_prompt_binding.setText(promptMorphConfigFrame[2])
            self.morph_promptA.setText(promptMorphConfigFrame[3])
            self.morph_promptB.setText(promptMorphConfigFrame[4])
            self.morph_prompt_min.setText(promptMorphConfigFrame[5])
            self.morph_prompt_max.setText(promptMorphConfigFrame[6])
            self.morph_prompt_value.setText(promptMorphConfigFrame[7])
            self.morph_prompt_slider.setMinimum(int(float(promptMorphConfigFrame[5]) * 100))
            self.morph_prompt_slider.setMaximum(int(float(promptMorphConfigFrame[6]) * 100))
            self.morph_prompt_slider.setValue(int(float(promptMorphConfigFrame[7]) * 100))
    ...
    def convert_to_prompt_morphing(self, isPromptBlending):
        ...
        if isPromptBlending:
            self.morph_promptA.setGeometry(QRect(103, 25, 145, 23))
        else:
            self.morph_promptA.setGeometry(QRect(103, 25, 305, 23))
        ...
        if isPromptBlending:
            ...
            self.morph_promptB.setGeometry(QRect(263, 25, 145, 23))
    ...
    def add_prompt_morph_blending_frame_to_container(self, isPromptBlending):
        ...
        self.morph_prompt_binding.setGeometry(QRect(8, 25, 83, 23))
        ...
        self.morph_promptA_label.setGeometry(QRect(104, 4, 89, 18))
        ...
        self.morph_prompt_slider.setGeometry(QRect(174, 54, 240, 28))
        ...
        self.morph_prompt_blending_checkbox.setGeometry(QRect(84, 50, 100, 14))
        ...
        self.morph_prompt_blending_checkbox_label.setObjectName(u"OnOffare_label" + str(self.identifier))
        self.morph_prompt_blending_checkbox_label.setGeometry(QRect(68, 70, 32, 9))
        self.morph_prompt_blending_checkbox_label.setMinimumSize(QSize(80, 9))
        font11 = QFont()
        ...
        self.OnOff_label.setObjectName(u"OnOffare_label" + str(self.identifier))
        ...
        self.morph_prompt_minmax_frame.setGeometry(QRect(416, 8, 81, 73))
        ...
        self.morph_prompt_max.setGeometry(QRect(45, 21, 28, 23))
        ...
        self.morph_prompt_minmaxbetween_label.setGeometry(QRect(35, 21, 10, 18))
        ...
        self.morph_prompt_min.setGeometry(QRect(3, 21, 28, 23))
        ...
        self.morph_prompt_min_label.setGeometry(QRect(0, 0, 25, 18))
        self.morph_prompt_min_label.setMinimumSize(QSize(30, 0))
        ...
        self.morph_prompt_max_label.setGeometry(QRect(42, 0, 25, 18))
        ...
        """self.remove_morph_prompt = QPushButton(self.parent.ui.horizontalWidget)
        self.remove_morph_prompt.setObjectName(u"remove_morph_prompt_" + str(self.identifier))
        self.remove_morph_prompt.setMaximumSize(QSize(12, 14))
        self.remove_morph_prompt.setStyleSheet(self.qbutton_style)
        self.remove_morph_prompt.setText(u"x")
        self.parent.ui.gridLayout_7.addWidget(self.remove_morph_prompt, self.identifier, 0, 1, 1)"""
    ...
    def resizeEvent_morph_frame(self, verticalFrame_prompt_width):
        ...
        if PromptAsize > 0:
            ...
            if self.isPromptBlending:
                self.morph_promptA.setGeometry(geo.x(),geo.y(), 145+int(PromptAsize/2), geo.height())
            else:
                self.morph_promptA.setGeometry(geo.x(),geo.y(), 305+int(PromptAsize/1), geo.height())
            ...
            if self.isPromptBlending:
                ...
                self.morph_promptB.setGeometry(263 + int(PromptAsize/2), geo.y(), 145 + int(PromptAsize/2), geo.height())

            geo = self.morph_prompt_minmax_frame.geometry()
            self.morph_prompt_minmax_frame.setGeometry(416 + int(PromptAsize/1),geo.y(), geo.width(), geo.height())

            geo = self.morph_prompt_slider.geometry()
            self.morph_prompt_slider.setGeometry(geo.x(),geo.y(), 240+int(PromptAsize/1), geo.height())
...
class Deforumation_Prompts():
    ...
    def replace_with_prompt_morph_bindings(self, promptItem):
        ...
        for morphFrame in self.prompt_morphing_container:
            is_enabled = not self.prompt_morphing_container[morphFrame].morph_prompt_enabled
            if not is_enabled:
                continue
    ...
    def colorMorphingPromtsDependingOnEnabledStatus(self, morph_frame):
        ...
        for promtWindow in promtWindows:
            ...
            while promtWindow.find("{{" + binding + "}}"):
                if morph_frame.morph_prompt_enabled:
    ...
    def set_prompt_morph_on_off(self, item):
        ...
        self.prompt_morphing_container[morph_prompt_identifier].set_prompt_morphing_on_off(item.isChecked(), False)
    ...
    def savePromptMorphingToFile(self):
        ...
        if file_name != "" and file_name != None:
            ...
            for morph_index in self.prompt_morphing_container:
                ...
                frame_data[index] = [int(morph_frame.morph_prompt_enabled), int(morph_frame.isPromptBlending), morph_frame.morph_prompt_binding.text(), morph_frame.morph_promptA.text(), morph_frame.morph_promptB.text(), morph_frame.morph_prompt_min.text(), morph_frame.morph_prompt_max.text(), morph_frame.morph_prompt_value.text()]
                index += 1
